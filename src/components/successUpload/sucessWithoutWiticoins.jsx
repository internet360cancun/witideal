...
import { Box, Paper, Grid, Button, useMediaQuery, IconButton } from '@material-ui/core'
  ...
  return (
    <PaperStyled elevation={3}>
      ...
      <Box p={isMobile ? 3 : 5}>
        ...
        <Box pt={1} pb={1}>
          <Name> Para que tu anuncio sea visible</Name>
        </Box>
        <Box pt={1} pb={1}>
        <Seconday>te invitamos a que compres un paquete de witicoins.</Seconday>
        </Box>
        <Box pt={4} pb={2}>
