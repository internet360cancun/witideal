                    ...
                    <div className="backcard1">
                      <div className="contenidocard">
                        ...
                        <div className="subtitulo">
                          ...
                          <br /> (Vigencia de 30 días){" "}
                        </div>
                        <div className="lista">
                          <br />
                          <p>
                            <strong style={{ color: "aqua" }}>+</strong> Campaña
                            de Facebook / Instagram Ads en la fanpage de
                            Witideal
                          </p>
                          <p>
                  ...
                  <div className="card cardplanes">
                    <div className="backcard3">
                      <div className="contenidocard">
                        ...
                        <div className="subtitulo">
                          (10 propiedades destacadas) <br /> (Vigencia de 30
                          días){" "}
                        </div>
                        <div className="lista">
                          <br />
                          ...
                          <p>
                            <strong style={{ color: "aqua" }}>+</strong> Mención
                            en el programa de radio / Luis Ramírez Mundo
                            Inmobiliario
                          </p>
                        </div>
                      </div>
