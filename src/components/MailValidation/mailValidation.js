                        ...
                        <Paper elevation={5}>
                            <Box p={{ xs: 2, sm: 5, md: 5, lg: 12 }}>
                                <Grid container justify='center' spacing={2}>
                                    <Grid item sm={12}>
                                        <Typography color="primary" variant='h5' className={classes.typeTitle}>Confirma tu cuenta en el correo electrónico que te acabamos de enviar.</Typography>
                                    </Grid>
                                    ...
                                    <Grid item sm={12}>
                                        <Button
                                            ...
                                            color="primary"
                                            variant='contained'
                                            size='large'>Volver a Enviar Correo</Button>
                                    </Grid>
