...
*/
  ...
  const onClickChangeNumber = (event) => setView("changeNumber");
            ...
            <Grid container justify="center" alignItems="center" spacing={1}>
              <Grid item xs={11} md={10}>
                ...
                <Typography gutterBottom align="center" variant="subtitle1">
                  Verifica tu celular. Revisa tus mensajes SMS y escribe el
  ...
  return (
    <React.Fragment>
      ...
      >
        <SnackbarContent className={classes.snackbarContent} message={modal} />
      </Snackbar>
    </React.Fragment>
  );
}
