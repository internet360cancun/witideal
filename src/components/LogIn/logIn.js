...
import { Grid, Box, Typography, TextField, makeStyles, Button, styled } from '@material-ui/core';
...
export function LogIn(props) {
  ...
  */
  ...
  const { nLog, gLog, fLog } = useFirebaseTools();
  const { handleChange, handleBlur, Errors, Values, setErrors } = useFormValidation(initialState, validateAuth);
            ...
            <React.Fragment>
              ...
              <Grid item xs={12}>
                <Button
                  ...
                  variant='outlined'
                  size='large'>
                  <img className={classes.logoSocial} src={Google} alt="Inicia Sesión con tu cuenta de Google a Witideal para disfrutar nuestros beneficios en la búsqueda de tu inmueble"></img>
              ...
              <Grid item xs={2}>
                <Typography className={classes.typeSubtitle} align='center'> o </Typography>
              </Grid>
              ...
              <Grid item xs={12} >
                ...
                <Box mt={2}>
                  <Link onClick={props.dismissModal} to={ROUTES.FORGOT} className={classes.linkDecoration}>
                    <Typography
                      className={classes.linkColor}
                      display="block"
                      align='center'>Olvidé mi contraseña...
                    </Typography>
                  </Link>
                </Box>
              </Grid>
              ...
              <Grid item xs={12}>
                <Typography variant='subtitle1' align='center' style={{fontWeight:'bold', color: 'gray'}}>
                  ¿No tienes cuenta?<RegisterLink onClick={props.changeToRegister}>  Regístrate </RegisterLink>
                </Typography>
              </Grid>
            </React.Fragment>
        }
