...
const SectionSix = () => {
  return (
    <div
      className="view viewstyle6"
      id="section6"
      style={{
        background: "linear-gradient(254.35deg, #3f19f9 8.47%, #41b8f9 94.38%)",
    ...
    >
          ...
          <div className="row align-items-center text-center">
            <div className="col text-center col-md-12">
              <div className="BannerTitle5">
                Algunas de nuestras redes donde podrían{" "}
                <strong style={{ color: "#32ffd2" }}>
                  verse tus anuncios y tus marcas
                </strong>
              </div>
              <br />
            </div>
            ...
            <div className="row justify-content-center justify-content-md-center">
              <div className="col-4 mx-auto">
                <div className="d-flex justify-content-center">
                  <img src={mudoinv} width="550vh" alt="" />
                </div>
              </div>
              ...
              <div className="col-4 mx-auto">
                <div className="d-flex justify-content-center">
                  <img src={legalglobal} width="100%" alt="" />
                </div>
              </div>
              <div className="col-0 mx-auto">
                <div className="text-center">
          ...
          <div className="brandsstylemobile justify-content-center">
            <div className="row">
              <div className="col mx-auto">
                <div className="d-flex justify-content-center">
                  <img className="brand1" src={mudoinv} alt="" />
                </div>
                <br />
                <div className="d-flex justify-content-center">
                  <img className="brand1" src={legalglobal} alt="" />
                </div>
                <br />
                <div className="d-flex justify-content-center">
                  <img src={rematecasas} alt="" />
      ...
      <div className="bannerbajo">
        <div className="d-flex justify-content-center">
          <img className="imgradio" src={radio} alt="" />
        </div>
          ...
          <div className="row">
            <div className="col">
              <div className="textbanner text-center">
                ...
                <strong style={{ color: "aqua" }}> RADIO +</strong> reconocido
                del <strong style={{ color: "aqua" }}> GIRO</strong>
              </div>
            </div>
          </div>
        </div>
